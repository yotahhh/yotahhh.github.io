...
const Mixing = () => {
  return (
    <div className="container mx-auto px-6 py-32 max-w-5xl text-primary font-sans min-h-screen flex items-center justify-center">
      <motion.div 
        initial={{ opacity: 0, scale: 0.95 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.5 }}
        className="relative border border-primary/10 p-12 max-w-2xl w-full bg-background/50 backdrop-blur-md shadow-2xl"
      >
        <div className="space-y-8 text-center md:text-left">
          <h2 className="text-3xl font-bold tracking-tight mb-4">Mixing & Mastering</h2>
          ...
          <div className="pt-8 border-t border-primary/10 flex flex-col items-center md:items-start gap-4">
            ...
            <a 
              ...
              className="inline-block px-8 py-3 bg-primary text-background font-bold tracking-wider hover:bg-[var(--hover-color)] transition-colors duration-300 font-mono uppercase"
            >
              Get In Touch
            </a>
          </div>
